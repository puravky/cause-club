...
const faqs = [
  {
    ...
    a: "Each month, every active member is automatically entered. We randomly draw 5 numbers. If your number matches, you win. It's that simple.",
  },
  {
  ...
  },
  {
    ...
    a: "If your number matches, we'll notify you by email and on your dashboard. You upload a simple verification form and the prize is paid out within 5 working days.",
  },
  {
    q: "Is this legal?",
