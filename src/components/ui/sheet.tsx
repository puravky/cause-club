  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-0 z-50 h-full w-full max-w-md gap-4 bg-popover p-6 text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none overflow-y-auto data-open:animate-in data-closed:animate-out",
          side === "right"
